...
export default function TermsPage() {
  ...
  const termsSections = [
    ...
    {
      icon: iconMap.policies,
      key: 'policies' as const,
    },
    {
      icon: iconMap.liability,
      ...
      <section className="relative text-white section-padding animate-fade-in min-h-[40vh] flex items-center bg-slate-900 dark:bg-slate-950">
        <div className="container-custom relative z-10">
          <div className="max-w-3xl">
            <h1 className="heading-primary text-white mb-6">{t.terms.pageTitle}</h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              {termsSections.map((section, index) => {
                ...
                const sectionData = t.terms.sections[section.key]
                return (
                  <div
                    key={section.key}
            ...
            <div className="mt-16 p-8 card animate-fade-in-up">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t.terms.questionsTitle}</h3>
              <p className="text-body mb-6">
                {t.terms.questionsDesc}
              </p>
              <div className="space-y-2 text-body">
                <p>
                  <strong>{t.contact.email}:</strong> {process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'legal@insurance.gov.sy'}
                </p>
                <p>
